...
module.exports.languages = {
	"vi": {
		"returnResultDefault": "%1 là số roll bạn cần để nổ vàng ጿ ኈ ቼ ዽ",
...
module.exports.run = function ({ event, api, args, getText }) {
    ...
    if (args.length == 0) return api.sendMessage(getText("returnResultDefault", Math.floor(Math.random() * 90)), threadID, messageID);
