...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage(`${e} ơi mày không thoát được đâu😎\nCó phải mày vừa gỡ này không? : ${m.msgBody}`, u); {
			let t = 0,
				s = {
					body: `${e} ơi mày lại gỡ gì thế? ${m.attachment.length} Gỡ này à?😒 .${""!=m.msgBody?`\n\nNội dung: ${m.msgBody}`:""}`,
					attachment: [],
					mentions: {
						tag: e,
						id: l
